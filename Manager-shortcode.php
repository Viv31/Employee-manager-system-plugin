<?php
/**
Shortcode section for Manager List of inserted data for fetching all list here

*/
if(!function_exists('starts360ManagerListShortcode')){

function starts360ManagerListShortcode(){
	$args = array(
'post_type'=> 'starts-manager',
'orderby'    => 'ID',
'post_status' => 'publish',
'order'    => 'DESC',
...
add_shortcode("MangerListing","starts360ManagerListShortcode");//First aparameter is shortcode name and second parameter is function  name
